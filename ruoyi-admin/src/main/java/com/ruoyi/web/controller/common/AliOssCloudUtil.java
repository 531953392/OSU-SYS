...
public class AliOssCloudUtil {
    ...
    private String endpoint = "oss-cn-shanghai.aliyuncs.com";    //阿里云的accessKeyId
    private String accessKeyId = "LTAI5tBsySH1QkPkUrXJRhtw";
    //阿里云的accessKeySecret　　
     private String accessKeySecret = "urA8bVPFiEWtPbapj6CZ7Bz7L8eXgM";

    //空间
    private String bucketName = "osufile";

    //文件存储目录
    private String filedir = "sysOsu/";
